...
// This component displays a 404 Not Found page with a gradient background and a button to return to the home page.
// It uses a glassmorphism effect for the content box and includes a large "404" indicator.